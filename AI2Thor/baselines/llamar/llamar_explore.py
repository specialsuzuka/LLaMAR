...
from AI2Thor.explore import ExploreEnv

# import utils for this baseline
from AI2Thor.baselines.llamar.llamar_utils_explore import *
from AI2Thor.baselines.llamar.tangible_objects import *
...
for step_num in tqdm.trange(timeout):
    ...
    if "Explore" in action:
        # print(f'llm actions:{action} | subtask:{env.open_subtasks}')
        objs = extract_tangible_objects(env.open_subtasks)
        d1, successes = env.explore(action, env.open_subtasks)
    else:

...
from AI2Thor.baselines.llamar_ablations.planner_actor_corrector.llamar_utils import *
...
for step_num in tqdm.trange(timeout):
    ...
    # NOTE: the change in this ablation is here by replacing the verifier output with oracle completed subtasks
    env.input_dict["Robots' completed subtasks"] = (", ").join(
        env.checker.get_completed_subtasks
    )

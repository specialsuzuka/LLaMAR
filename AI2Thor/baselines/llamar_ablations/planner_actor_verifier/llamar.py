...
from AI2Thor.baselines.llamar_ablations.planner_actor_verifier.llamar_utils import *
...
for step_num in tqdm.trange(timeout):
    ...
    preaction, reason, subtask, memory = process_action_llm_output(outdict)
    action = print_stuff(env, preaction, reason, subtask, memory)
